...
def main():
    stimulus_type = 'PlugIn_2024062801-v0.8.7_GoodCell3'  # 'PlugIn_2024062802' 'PlugIn_2024062801-v0.8.7_GoodCell3' get the name from the check point folder
    ...
    test_config_name = 'neuro_exp3_3cell_061424_test_2'  # default: None, for natural images 'neuro_exp3_3cell_061424_test_3'
