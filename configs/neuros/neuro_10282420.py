...
neu_dir = '/storage1/fs1/KerschensteinerD/Active/Emily/RISserver/VideoSpikeDataset/experiment_neuron_080224.mat'
...
included_neuron_table = load_data_from_excel(exp_dir, 'nid_9', usecols=[0, 1])
