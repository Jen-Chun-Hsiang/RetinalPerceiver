...
sim_dir = '/storage1/fs1/KerschensteinerD/Active/Emily/RISserver/VideoSpikeDataset/ExperimentSheets.xlsx'

query_table = fill_blanks_from_excel(sim_dir, sheet_name='Standard', cell_range='B3:D30')
