...
def main():
    stimulus_type = 'PlugIn_2024061101-v0.8.2_GoodCell3'  # get the name from the check point folder
    ...
    test_config_name = 'neuro_exp1_3cell_041324_test_12'  # 'neuro_exp1_3cell_041324_test_12' None
