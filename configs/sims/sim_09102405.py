...
query_table = fill_blanks_from_excel(sim_dir, sheet_name='Masking', cell_range='AE1:AH169')
...
encoding_type = {'Experiment': 'uniform', 'Type': 'uniform', 'Eccentricity': 'extend', 'Coord_x': 'extend',
                 'Coord_y': 'extend'}
